const tags = `
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
      <g fill="none" fill-rule="evenodd" transform="rotate(45 6.718 9.39)">
          ...
          <path fill="#282828" fill-rule="nonzero" d="M9 5h8v1H9zM9 8h8v1H9z"/>
          <circle cx="6" cy="7" r="1" fill="#282828" fill-rule="nonzero"/>
      </g>
  </svg>
`;
