...
const BOOST_SECTION = '8';
const WHAT_IS_BOOST = '8.0';
const HOW_TO_MAKE_A_STAKE = '8.1';
const HOW_TO_MAKE_A_STAKE_AUTOMATICALLY = '8.2';
const WHY_ARE_MY_TOKENS_LOCKED = '8.3';
const WHEN_I_CAN_GET_MY_REWARD = '8.4';

const WHAT_IS_PROMOTED_QUESTION = '9.0';
