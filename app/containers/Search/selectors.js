...
const selectItems = () => createSelector(selectSearchDomain, (substate) => substate.items);
...
export { selectSearchDomain, selectItems, selectGetResultsProcessing, selectGetResultsError };
