...
export const UNSUBSCRIBE_EMAIL_ADDRESS_ERROR =
  'app/emailNotifications/GUNSUBSCRIBE_EMAIL_ADDRESS_ERROR';

export const EMAIL_FORM = 'app/emailNotifications/EMAIL_FORM';
export const SEND_EMAIL_FORM = 'app/emailNotifications/SEND_EMAIL_FORM';
export const CONFIRM_EMAIL_FORM = 'app/emailNotifications/CONFIRM_EMAIL_FORM';
export const CHANGE_EMAIL_FORM = 'app/emailNotifications/CHANGE_EMAIL_FORM';
export const ENTER_EMAIL_FORM = 'app/emailNotifications/ENTER_EMAIL_FORM';

export const EMAIL_FIELD = 'app/emailNotifications/EMAIL_FIELD';
export const CODE_FIELD = 'app/emailNotifications/CODE_FIELD';
export const NEW_EMAIL_FIELD = 'app/emailNotifications/NEW_EMAIL_FIELD';
export const CONFIRM_EMAIL_FIELD = 'app/emailNotifications/CONFIRM_EMAIL_FIELD';
export const PASSWORD_FIELD = 'app/emailNotifications/PASSWORD_FIELD';

export const CHECK_EMAIL_IMG_ALT = 'check your email';
