export const uniqueAchievementsArr = [
  ...
  },
  {
    ...
    lowerValue: 100,
    upperValue: 499,
    limit: process.env.ENV === 'prod' ? 10 : 5,
  },
  {
    id: 32,
    title: 'RESEARCHER',
    lowerValue: 500,
    upperValue: 999,
    limit: process.env.ENV === 'prod' ? 5 : 5,
  },
  {
    id: 33,
    ...
    lowerValue: 1000,
    upperValue: 2499,
    limit: process.env.ENV === 'prod' ? 4 : 5,
  },
  {
    id: 34,
    title: 'THE_WISEST',
    lowerValue: 2500,
    upperValue: 4999,
    limit: process.env.ENV === 'prod' ? 3 : 5,
  },
  {
    id: 35,
    title: 'MODERN_HERO',
    lowerValue: 5000,
    upperValue: 9999,
    limit: process.env.ENV === 'prod' ? 2 : 5,
  },
  {
    id: 36,
    ...
    lowerValue: 10000,
    upperValue: Infinity,
    limit: process.env.ENV === 'prod' ? 1 : 10,
  },
];
