/*
 *
 * ChangePasswordByPrevious constants
 *
 */
...
export const CHANGE_PASSWORD_ERROR =
  'app/ChangePasswordByPrevious/CHANGE_PASSWORD_ERROR';

export const SHOW_CHANGE_PASSWORD_MODAL =
  'app/ChangePasswordByPrevious/SHOW_CHANGE_PASSWORD_MODAL';
export const HIDE_CHANGE_PASSWORD_MODAL =
...
// Fields
export const EMAIL_FIELD = 'app/ChangePasswordByPrevious/EMAIL_FIELD';
export const CODE_FIELD = 'app/ChangePasswordByPrevious/CODE_FIELD';
export const OLD_PASSWORD_FIELD =
  'app/ChangePasswordByPrevious/OLD_PASSWORD_FIELD';
export const NEW_PASSWORD_FIELD =
  'app/ChangePasswordByPrevious/NEW_PASSWORD_FIELD';
export const CONFIRM_PASSWORD_FIELD =
  'app/ChangePasswordByPrevious/CONFIRM_PASSWORD_FIELD';
