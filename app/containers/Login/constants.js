...
export const FACEBOOK_LOGIN_BUTTON_CLICK = 'FACEBOOK_LOGIN_BUTTON_CLICK';
export const FACEBOOK_LOGIN_DATA_RECEIVE = 'FACEBOOK_LOGIN_DATA_RECEIVE';

export const FACEBOOK_SIGN_UP_INITIATED = 'FACEBOOK_SIGN_UP_INITIATED';
