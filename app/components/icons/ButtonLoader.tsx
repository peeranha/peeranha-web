...
const ButtonLoader: React.FC<IconProps> = (props): JSX.Element => (
  <IconComponent
    {...props}
  ...
  >
    <path
      ...
      fillOpacity="0.2"
    />
    <path d="M18 0C22.6181 5.507e-08 27.0595 1.77495 30.4056 4.95774C33.7517 8.14052 35.7466 12.4876 35.9775 17.0999L34.0007 17.1989C33.7952 13.0938 32.0197 9.22465 29.0415 6.39183C26.0633 3.55902 22.1103 1.97923 18 1.97923V0Z" />
  </IconComponent>
);
