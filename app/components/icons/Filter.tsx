...
const Filter: React.FC<IconProps> = (props): JSX.Element => (
  <IconComponent {...props} fill="currentColor" viewBox="0 0 18 18" size={[18, 18]}>
    <g stroke={props.stroke || '#282828'} fill="none">
      <circle fillOpacity=".2" fill={props.fill || '#282828'} cx="4.5" cy="8.5" r="2" />
      <circle fillOpacity=".2" fill={props.fill || '#282828'} cx="12.5" cy="2.5" r="2" />
      <circle fillOpacity=".2" fill={props.fill || '#282828'} cx="12.5" cy="14.5" r="2" />
