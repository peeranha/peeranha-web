...
const Languages: React.FC<IconProps> = (props): JSX.Element => (
  <IconComponent {...props} id="languages" fill="currentColor" viewBox="0 0 18 18" size={[18, 18]}>
    <g fill="none">
      <circle
        cx="9.5"
        cy="8.5"
      ...
      />
      <path fill={props.stroke || '#282828'} d="M9 1h1v15H9z" />
      <path fill={props.stroke || '#282828'} d="M2 9V8h15v1zM3 6V5h13v1zM3 12v-1h13v1z" />
    </g>
  </IconComponent>
);
