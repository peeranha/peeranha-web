...
const Delete: React.FC<IconProps> = (props): JSX.Element => (
  <IconComponent {...props} fill="currentColor" viewBox="0 0 18 18" size={[18, 18]}>
    <rect x="7" y="8.5" width="1" height="6" rx="0.5" fill={props.fill || '#282828'} />
    <rect x="10" y="8.5" width="1" height="6" rx="0.5" fill={props.fill || '#282828'} />
    <path
      opacity="0.9"
    ...
    />
    <rect x="1" y="4.5" width="16" height="1" rx="0.5" fill={props.fill || '#282828'} />
    <path
