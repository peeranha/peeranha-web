...
const UsersBig: React.FC<IconProps> = (props): JSX.Element => (
  <IconComponent {...props} fill="currentColor" viewBox="0 0 43 43" size={[43, 43]}>
    <g transform="translate(6 8)" fill="none">
      <circle stroke={props.stroke || '#282828'} strokeWidth="2" cx="9.5" cy="10.5" r="4.5" />
      <circle stroke={props.stroke || '#282828'} strokeWidth="2" cx="22.5" cy="6.5" r="4.5" />
      <path
      ...
      <path
        ...
        strokeWidth="2"
      />
      <circle stroke={props.stroke || '#282828'} fill="#FFF" cx="8.5" cy="9.5" r="5" />
      <circle stroke={props.stroke || '#282828'} fill="#BEBEBE" cx="21.5" cy="5.5" r="5" />
      <path
