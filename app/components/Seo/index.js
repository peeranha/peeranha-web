...
const Seo = ({
  ...
  const appName = domainName.replace(domainName[0], domainName[0].toUpperCase());
...
Seo.propTypes = {
  ...
  articlePublishedTime: PropTypes.oneOfType([PropTypes.string, PropTypes.instanceOf(Date)]),
  articleModifiedTime: PropTypes.oneOfType([PropTypes.string, PropTypes.instanceOf(Date)]),
