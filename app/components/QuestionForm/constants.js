...
const FORM_TYPE = 'app/AskQuestion/FORM_TYPE';
const FORM_BOUNTY = 'app/AskQuestion/FORM_BOUNTY';

export { FORM_TITLE, FORM_CONTENT, FORM_COMMUNITY, FORM_TAGS, FORM_TYPE, FORM_BOUNTY };
